...
# apt-get install default-openjdk
# install jazzer
cd jazzer
bazel run //:jazzer
# ./bazelisk-linux-amd64 run //:jazzer                                                                                                                                                                                                 1 ⨯
...
┌──(root💀kali)-[/home/kali/jazzer]
└─# export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:/home/kali/jdk-15.0.2/lib/server/                                                                                                                                                          127 ⨯
