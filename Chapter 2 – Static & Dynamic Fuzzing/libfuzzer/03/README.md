...
./buildconf
./configure CC="clang -O2 -fno-omit-frame-pointer -g -fsanitize=address,fuzzer "
make CFLAGS=
```
...
```bash
cd ..
clang++ -g c_ares_fuzzer.cc -O2 -fno-omit-frame-pointer -fsanitize=address,fuzzer -Ic-ares c-ares/.libs/libcares.a  -o c_ares_fuzzer
```
